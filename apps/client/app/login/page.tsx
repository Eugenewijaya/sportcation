...
import { AlertCircle, ArrowLeft, ArrowRight, Eye, EyeOff, LoaderCircle, LockKeyhole, Mail, Trophy } from "lucide-react"
  ...
  return (
    <main className="flex min-h-screen bg-zinc-50">
      ...
      <section className="relative hidden w-1/2 overflow-hidden lg:block bg-gray-900">
        <img src="https://images.unsplash.com/photo-1579952363873-27f3bade9f55?q=80&w=1470&auto=format&fit=crop" alt="Sports" className="absolute inset-0 h-full w-full object-cover opacity-60" />
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div>
            <h1 className="text-5xl font-black text-white leading-tight mb-4">
              Main Lebih Banyak,<br/>Ribet Lebih Sedikit.
            </h1>
            <p className="text-xl text-gray-300 font-medium">
              Booking lapangan favoritmu dalam hitungan detik. 
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-16">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-base text-gray-500 font-medium">Masuk untuk mulai cari lapangan atau jual jadwalmu.</p>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-zinc-50 px-4 text-gray-500 font-medium">atau pakai email</span>
            </div>
          </div>
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            >
              {submitting ? <LoaderCircle className="h-5 w-5 animate-spin" /> : "Gasss Masuk!"}
          ...
          <div className="mt-12 rounded-xl border border-dashed border-gray-300 p-4 text-center">
            <button
              onClick={() => { setEmail("customer@sportcation.local"); setPassword("password123") }}
              className="text-xs font-bold text-gray-400 hover:text-gray-600"
            >
              [Dev] Isi Data Demo Customer
            </button>
          </div>
        </div>
      </section>
