...
const placeNow = (el: HTMLElement, slot: SlotPosition, skew: number) =>
  gsap.set(el, {
    x: slot.x,
    y: slot.y,
    z: slot.z,
...
const CardSwap = ({
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as React.ReactElement<{ ref?: React.Ref<HTMLDivElement>; style?: React.CSSProperties; onClick?: React.MouseEventHandler }>, {
          key: i,
          ref: refs[i],
