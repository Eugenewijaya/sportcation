...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none' as const, opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#222', color: '#a3a3a3' },
          active: { scale: 1, backgroundColor: '#10b981', color: '#10b981' },
          complete: { scale: 1, backgroundColor: '#10b981', color: '#059669' }
        }}
